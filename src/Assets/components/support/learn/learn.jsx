                        ...
                        <div className="col sect">
                            ...
                            <div id="learnfaq">
                                <div className="accordian">
                                    ...
                                    <details>
                                        <summary>{t("what_is_cryptocurrency")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                            </span>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_cryptocurrency")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_cryptocurrency_token")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_cryptocurrency_token")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_are_the_commom_token_types")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_common_token_types")}</p>
                                            <p><strong>{t("utility_token")}</strong> {t("utility_token_text")}</p>
                                            <p><strong>{t("security_token")}</strong> {t("security_token_text")}</p>
                                            <p><strong>{t("stablecoin")}</strong> {t("stablecoin_text")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_cryptocurrency_coin")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_cryptocurrency_coin")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("difference_between_token_coin")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_difference_between_token_coin")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_blockchain")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_blockchain")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_blockchain_mining")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_blockchain_mining")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_gas")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        <summary>{t("what_is_smart_contract")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_smart_contact")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_an_nft")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        <summary>{t("what_is_an_metaverse")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_metaverse")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_an_cryptocurrency_exchange")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_cryptocurrency_exchange")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_fiat")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        <summary>{t("what_is_decentralization_in_blockchain")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_decentralization_in_blockchain")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_web3")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        <summary>{t("what_is_tokenization")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_tokenization")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_tokenization_blockchain")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("what_is_tokenization_blockchain_answer")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_cryptopair")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_cryptopair")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_the_bid_price")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_bid_price")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_ask_price")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_ask_price")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_is_spread")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        <summary>{t("what_are_main_chart_types")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("chart_types_used_most_trader")}</p>
                                            <p>{t("line_chart")}</p>
                                            <p>{t("bar_chart")}</p>
                                            <p>{t("candlestick_chart")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_types_of_market_conditions")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("there_two_types")}</p>
                                            <p>{t("bullish_market")}</p>
                                            <p>{t("bearish_market")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_does_scalping_mean")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                    ...
                                    <details>
                                        ...
                                        <div className='contt'>
                                            <p>{t("volatility_text")}</p>
                                        </div>
                                    </details>
                                    <details>
                                        <summary>{t("what_do_support_resistance_mean")}
                                            <span className='aas__ss'>
                                                <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.2657 0.850586C0.312684 0.850586 -0.19666 1.97304 0.430911 2.69023L5.33092 8.29028C5.9496 8.99735 7.04961 8.99735 7.6683 8.29028L12.5684 2.69023C13.1958 1.97304 12.6866 0.850586 11.7335 0.850586H1.2657Z" fill="white"/>
                                                </svg>
                                        ...
                                        <div className='contt'>
                                            <p>{t("answer_support_resistance")}</p>
                                        </div>
                                    </details>
                                </div>
                            </div>
