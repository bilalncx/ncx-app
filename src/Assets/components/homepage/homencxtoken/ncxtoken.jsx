            ...
            <div className="container">
                ...
                <div className="tokentable">
                    <div className="tokenhead">
                        ...
                        <p className="seven">Use NCXX as Derivatives Trading Collateral </p>
                        <p className="eight">Use NCXX as Collateral to Borrow other Crypto Assets</p>
