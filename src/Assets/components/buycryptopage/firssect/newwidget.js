...
function NCXWidget()
{
    return(
        <div className="economic_calendar">
            ...
            plotLineColorGrowing="rgba(152, 0, 255, 1)" gridLineColor="rgba(240, 243, 250, 0)" 
            scaleFontColor="rgba(106, 109, 120, 1)" belowLineFillColorGrowing="rgba(180, 167, 214, 0.12)" 
            belowLineFillColorFalling="rgba(180, 167, 214, 0.12)" belowLineFillColorGrowingBottom="rgba(41, 98, 255, 0)" 
            belowLineFillColorFallingBottom="rgba(41, 98, 255, 0)" symbolActiveColor="rgba(180, 167, 214, 0.12)">
