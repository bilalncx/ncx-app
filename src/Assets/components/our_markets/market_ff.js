...
function show(data) {
	...
	// USDC / USD
	const BUSDC1 = data.USDC_USD.id;
	const BUSDC_ID = BUSDC1.replace(/_/g, " / ");  
	
	const BUSDC2 = data.USDC_USD.last;
	const BUSDC_Price = parseFloat(BUSDC2);
	const BUSDC_Pricenew = parseFloat(BUSDC2).toFixed(2);
	
	const BUSDC3 = data.USDC_USD.high24hr;
	const BUSDC_High = parseFloat(BUSDC3).toFixed(4);
	
	const BUSDC4 = data.USDC_USD.low24hr;
	const BUSDC_Low = parseFloat(BUSDC4).toFixed(4);

	const BUSDC5 = data.USDC_USD.percentChange * 100;
    const BUSDCChanged = parseFloat(BUSDC5).toFixed(4);
