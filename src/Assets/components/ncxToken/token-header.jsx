        ...
        <Toolbar>
          <div id="main-header" className="desktop">
            ...
            <div className="login-buttons">
              <Button href="#" target="_blank" rel="noreferrer" className="signin">Claim Airdrop</Button>
              <Button className="launch-dex" href="https://my.ncx.cx/en/login" target="_blank" rel="noreferrer">Sign In</Button>
