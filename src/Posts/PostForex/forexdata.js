const data = [
  ...
  },
  {
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 7:03 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692872755/ncx-blog-1174_vql7hs.webp',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>The pound and euro fell against the US dollar (USD) on Wednesday on the back of disappointing economic data that points to a possible recession over the remainder of the year.</p>
    	<p>The pound (GBPUSD=X) fell 0.38% against the dollar to $1.26, while the euro (EURUSD=X) also declined against the dollar, by 0.06% to $1.08.</p>	
    	<p>It comes as UK PMI data released on Wednesday showed a sharp fall in private sector output.</p>	
    	<p>“The UK readings were particularly stark, with both the services and manufacturing PMIs falling well short of forecasts and the former deep into contraction territory,” Craig Erlam, senior market analyst at OANDA, said.</p>
      <p>Weakness was widespread from new orders to hiring, "which suggests we're not just talking about a blip in the data, but rather the prospect of a recession in the second half of the year,” he added.</p>
      <p>Meanwhile, Eurozone figures also failed to cheer investors prompting the euro to collapse to almost two-month lows on the USD.</p>
      <p>“Today’s underwhelming Euro Area (Eurozone) PMI data raises doubts over the possibility of additional ECB interest rates hikes,” Matthew Ryan, head of market strategy at financial services firm Ebury, said.</p>
      <p>“Core inflationary pressures remain elevated, tighter monetary conditions are squeezing household spending power and soft Chinese demand looks set to dampen export revenue.</p>
      <p>“For now, we continue to expect one final interest rate increase from the European Central Bank at either its September or November meetings, although the weak growth environment suggests that an end to hikes isn’t too far away. This could present a downside risk to our otherwise bullish view on EUR/USD.”</p>
      <p>The Bank of England is also likely to hike interest rates further before year-end, although, we may begin to see a more vocal dovish dissent among the committee, as policymakers balance high core inflation with an economy verging on stagnation, according to Ryan.</p>
      <p>However, Martin Beck, chief economic advisor to the EY ITEM Club said in a note to clients that the combination of a slowdown in both activity and inflation suggests a rate increase is no longer a certainty.</p>
      <p>“On balance, the EY ITEM Club thinks the latest survey findings may not be enough to deter the Bank of England from raising interest rates again, given recent developments in pay and services inflation,” he said.</p>
      <p>“But they do reinforce the EY ITEM Club’s expectation that a rate rise next month, if it happens, will likely be the last in the current cycle.”</p>
    </div>
  },
  {
    id: 642,
    title: 'USD/JPY Forecast – US Dollar Continues to Look to the Upside Against Yen',
    category: 'Forex',
    subCategory: ['USD', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>On Wednesday’s trading day, the US dollar started off with a dip, but then it turned around and showed some signs of life. All in all, I’m thinking the market’s looking at the ¥145 level as a possible support point, even though it used to be a big resistance hurdle. Also, we can’t ignore the psychology around that ¥145—it’s got quite an impact.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 6:16 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692872376/ncx-blog-1173_dmaijk.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
	    <h3>US Dollar vs Japanese Yen Technical Analysis</h3>
	    <p>On Wednesday’s trading day, the US dollar started off with a dip, but then it turned around and showed some signs of life. All in all, I’m thinking the market’s looking at the ¥145 level as a possible support point, even though it used to be a big resistance hurdle. Also, we can’t ignore the psychology around that ¥145—it’s got quite an impact.</p>
	    <p>Underneath that, the ¥142.50 level has seen its share of action before. Plus, you’ve got the 50-Day Exponential Moving Average right around there. That could be the market’s base, especially if we look at the bigger uptrend. But keep in mind, the next couple of days might be kind of quiet, as everyone’s waiting for Jerome Powell’s talk on Friday at the Jackson Hole Symposium. Right now, most traders are trying to figure out whether the Federal Reserve will stick to its tight policy or not.</p>	
	    <p>At this point, the focus might shift to spotting opportunities when the price goes down a bit, especially since the Bank of Japan is still keeping things super loose with their money policy. In this situation, I’m guessing the market might see the ¥147.50 level as a possible goal. If we manage to get past that, the next target could be hitting ¥150. But remember, this market’s got a lot of noise ahead. The speech on Friday might be the next big thing to shake things up. So, we might just move back and forth until then—unless some traders try to get ahead of the Fed and the speech, which sometimes happens. But often, that’s not the right call. Sometimes the markets are driven by hope, like in this case, hoping for cheap money from the Fed.</p>	
	    <p>Just looking at the difference in interest rates gives some pretty good reasons for the US dollar to stay strong against the Japanese yen. But it’s not only the US dollar—it could have an impact on other currencies too, like the British pound, Australian dollar, New Zealand dollar, Canadian dollar, and more. Remember, this is a relative agreement. The Japanese yen might just keep being not so strong against various other global currencies. So, one thing I’m pretty sure about is that I won’t be buying the Japanese yen against anything any time soon. The current trend backs up this idea, making the yen likely to be on the receiving end of advances from other currencies.</p>
    </div>
  },
  {
    id: 641,
    title: 'GBP/USD Forecast – British Pound Gets Hammered',
    category: 'Forex',
    subCategory: ['GBP', 'USD', 'Forecast'],
    description: <div className="blog-desc">
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 6:12 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692872131/ncx-blog-1172_khomtp.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
	    <h3>British Pound vs US Dollar Technical Analysis</h3>
	    <p>The British pound has seen a certain amount of negativity over the last 24 hours, specifically after the PMI numbers in the United Kingdom came out much lighter than anticipated. In fact, both of them are contractionary, so now people are running toward the US dollar. That being said, it’s worth noting that the PMI numbers in the United States have yet to be released, and if they are equally as miserable, we could see a complete turnaround.</p>
	    <p>That being said, we are also between the 50-Day EMA in the 200-Day EMA indicators, which in itself can cause quite a bit of noisy behavior. All things being equal, this is a market that I think continues to see a lot of noisy behavior, with the Jackson Hole Symposium speech is coming out on Friday. This of course will have a major influence on what happens next, and of course people out there are looking toward the tone of the Jerome Powell speech.</p>	
	    <p>If the Chairman of the Federal Reserve strikes a hawkish tone, that obviously will be strong for the US dollar, but it seems like people out there are trying to not believe him any chance they get. Regardless, I think what we are looking at is a market that simply in a bit of a holding pattern, despite the fact that we have seen a significant selloff early during the Wednesday session.</p>	
    	<p>Underneath, we also have a major uptrend line, and therefore I think we’ve got a situation where there is so much support that is going to take something somewhat extraordinary to break this market down. If we do break down below the 200-Day EMA, then it’s likely that we continue to see a lot of negativity. Ultimately, if that were to happen you would probably see a huge run toward the US dollar overall, not just with the British pound. Ultimately, I think we have a situation where you have to look at this through the prism of whether or not we are going to get more of a value play, or if we are going to get some type of breakdown. The next several days could answer that question.</p>
    </div>
  },
  {
    id: 640,
    title: 'GBP/JPY Forecast – British Pound Drops Against Yet',
    category: 'Forex',
    subCategory: ['GBP', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound has fallen rather hard against the Japanese yen during trading on Wednesday, as we continue to see a lot of volatility in the Forex markets. PMI numbers in the United Kingdom came out weaker than anticipated, therefore we have seen the British pound itself get hammered.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 6:09 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692871911/ncx-blog-1171_s6j6c8.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
	    <h3>British Pound vs Japanese Yen Technical Analysis</h3>
	    <p>The British pound has fallen rather hard against the Japanese yen during trading on Wednesday, as we continue to see a lot of volatility in the Forex markets. PMI numbers in the United Kingdom came out weaker than anticipated, therefore we have seen the British pound itself get hammered.</p>
    	<p>People were speculating that perhaps the Bank of England will have to cut rates, but when you look at the longer-term charts, you can see that this is more likely than not going to end up being a buying opportunity. After all, the Bank of Japan is nowhere near tightening its monetary policy, and even if the British did decide to do a quarter-point cut suddenly, it would still leave a spread between interest rates that you could drive a truck through.</p>	
	    <p>At this point, I will be looking for signs of a bounce that I can take advantage of, and therefore a short-term hammer or some other type of candlestick to at least give me a benchmark to go into the market. The 50-Day EMA currently sits right around the ¥181.50 level and is rising. I think that is a soft “floor of the market”, with the real “floor” being closer to the ¥180 level.</p>	
    	<p>The candlestick that we have made during the trading session on Friday, is of course a very ugly candlestick to say the least. In other words, we may have a little bit of follow-through, but the lower we go, the more interested I am in picking up value. After all, the Japanese yen continues to get hammered against most things, and the British pound will remain in that given enough time. If we can recapture the ¥185 level, this is a market that I think could go much higher, perhaps trying to break above the recent highs and look into the ¥190 level. All things being equal, I still think that we could go all the way to the ¥200 level, but that doesn’t necessarily mean that we are going to see it sometime in the next few days, so make sure that you are somewhat measured in your approach.</p>
    </div>
  },
  {
    id: 639,
    title: 'AUD/USD Forecast – Aussie Continues to See a Lot of Overhead Pressure',
    category: 'Forex',
    subCategory: ['AUD', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>During Wednesday’s trading, the Australian dollar had a solid rally, bouncing back from the 0.64 level. Buyers might have their sights on the 0.65 level above, and that could include those looking to close out short positions. The situation is interesting, but the real question is whether we can actually reach that level.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 6:04 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692871720/ncx-blog-1170_n8xvty.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
	    <h3>Australian Dollar vs US Dollar Technical Analysis</h3>
    	...
    	<p>Checking out the 50-Day Exponential Moving Average, it’s currently at around 0.66 and moving down. That could act as a technical point of resistance. All in all, owning the Australian dollar right now might not be the smartest move, especially when compared to the US dollar. If we end up going below the lows we saw last week, there’s a chance we could drop to 0.63 or maybe even lower.</p>	
	    <p>Considering the pretty big drop we’ve seen in the last couple of months, a bit of a bounce back wouldn’t be crazy. Monday and Tuesday’s moves seemed to suggest that vibe, hinting at a “fade the rally” kind of approach. With all the noise in the market, it’s crucial to approach things with a clear perspective. Right now, it looks like finding value in the US dollar might be a solid move, considering how much it’s gone down. To put it simply, jumping straight into shorting after such a big move might not be the best call. A more careful, short-term approach could be smarter, grabbing chances to go short little by little as they come up.</p>	
	    <p>In a nutshell, the Australian dollar had a good boost during Wednesday’s trading, coming back from the 0.64 level. The 0.65 level above could be a target for buyers or those looking to close short positions but hitting it might bring on a wave of selling. The Australian dollar has its reasons for being shorted, partly because of the Federal Reserve’s strict approach and its connection to the global mobile economy and risk appetite. The 50-Day EMA at 0.66 could be a barrier. Right now, it might not be the best call to hold onto the Australian dollar against the US dollar. If we dip below last week’s lows, we could drop to 0.63 or even lower.</p>
      <p>Despite the recent fall, a bit of a bounce back wouldn’t be out of the ordinary. Monday’s moves gave off that vibe, suggesting a “fade the rally” approach. With all the noise in the market, it’s important to approach it with a clear perspective. It seems like finding value in the US dollar could be a good move right now, considering how much it’s dropped. To put it simply, diving into shorting right after such a big move might not be the best plan. A more careful, short-term strategy might make more sense, grabbing opportunities to go short bit by bit as they come.</p>
    </div>
  },
  {
    id: 638,
    title: 'EUR/USD Forecast – Euro Gives Up Initial Gains',
    category: 'Forex',
    subCategory: ['EUR', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The euro initially tried to rally a bit during the trading session on Wednesday but ran into problems with PMI numbers coming in lower than anticipated in the European Union. This suggests that we are in fact heading into a recession in the European Union,</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 5:24 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692871247/ncx-blog-1169_zsfzor.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
    	<h3>Euro vs US Dollar Technical Analysis</h3>
	    <p>The euro initially tried to rally a bit during the trading session on Wednesday but ran into problems with PMI numbers coming in lower than anticipated in the European Union. This suggests that we are in fact heading into a recession in the European Union, something that makes quite a bit of sense, especially considering that Europe is going to have problems with power later this year. In other words, we could be seeing a bigger move, but we also have to keep an eye on PMI numbers coming out of the United States. Beyond that, the real fireworks may be on Friday, as the central bank leaders of both the Federal Reserve and the European Central Bank have speeches at Jackson Hole.</p>
    	<p>At this point, if we break down below the 200-Day EMA, it opens up a move down to the 1.0650 level, which is an area that I think will be important. All things being equal, I think we’ve got a situation where the market certainly looks very frail, but part of this could come down to the PMI numbers coming out late during the session on Wednesday from the United States. After all, if America finds itself in the same position, then it will end up being a “no harm, no foul” type of situation.</p>	
    	<p>All things being equal, I do think that the US dollar is a being more attractive than the euro over the longer term, especially considering that the global economy could be running into some issues. Ultimately, one of the biggest things that we have to pay attention to is that we are between the 200-Day EMA indicator and the 50-Day EMA indicator, which typically means we are about to make a big move. By the end of the week, I suspect that we will know where the next leg in this market runs to. Between now and then, I suspect that we are going to have more choppiness than anything else, although when I look at the chart right now, it certainly looks as if the downside has a little bit more power. Whether or not that holds remains to be seen.</p>	
    </div>
  },
  {
    id: 637,
    title: 'Politics, Fed seen swaying Japan yen intervention thinking',
    category: 'Forex',
    subCategory: ['Politics', 'Fed', 'Japan'],
    description: <div className="blog-desc">
      <p>TOKYO (Reuters) -The Federal Reserve's Jackson Hole symposium this week looms as a key risk for Japanese authorities worried that new hawkish signals from U.S. central bankers could trigger another sharp yen selloff that would force Tokyo to prop up the currency.</p>
    </div>,
    authorName: 'Leika Kihara and Tetsushi Kajimoto',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 23, 2023 - 12:19 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692870670/ncx-blog-1168_f0dhyj.webp',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>By Leika Kihara and Tetsushi Kajimoto</p>
    	<p>TOKYO (Reuters) -The Federal Reserve's Jackson Hole symposium this week looms as a key risk for Japanese authorities worried that new hawkish signals from U.S. central bankers could trigger another sharp yen selloff that would force Tokyo to prop up the currency.</p>	
    	<p>The annual gathering of Fed officials and other global policymakers has historically been an opportunity for central bankers to regroup and flag their next big steps to markets.</p>	
    	<p>Until recently, investors had expected Fed Chair Jerome Powell might be looking to end to interest rate hikes amid signs inflation was moderating.</p>
      <p>The worry now for Japanese officials is that he signals the opposite as price pressures linger, which could trigger a repeat of last year's yen selloff against the dollar, forcing authorities to intervene again.</p>
      <p>While the yen's fortunes are largely a product of dollar movements, the currency's weakness has become politically problematic not only for Prime Minister Fumio Kishida but also the Bank of Japan, whose ultra-loose monetary settings have been blamed for inflating import costs.</p>
      <p>"Authorities aren't worried about the weak yen as much as they were around September and October last year," said Masafumi Yamamoto, chief currency strategist at Mizuho Securities.</p>
      <p>"But the chance of intervention will heighten if a worsening economy hurts the administration's approval ratings."</p>
      <p>Money markets expect the Fed to maintain rates in the current 5.25%-5.5% range until the second quarter next year before starting to ease. But investors will be looking for clues about possible additional rate hikes from Powell's speech on Friday.</p>
      <p>BOJ Governor Kazuo Ueda is scheduled to attend the Jackson Hole meeting, which has thrown Japan curve balls in the past.</p>
      <p>In 2010, former Fed Chair Ben Bernanke's suggestion of deploying quantitative easing triggered a yen spike that forced then BOJ head Masaaki Shirakawa to cut short his stay at the retreat, and call an emergency meeting in Tokyo to ease monetary policy.</p>
      <p>This time around, concerns centre on yen weakness.</p>
      <p>To be sure, Japan has not been as worried by recent bouts of yen selling, issuing fewer verbal warnings even as the dollar breached the 145 mark that triggered intervention last year.</p>
      <p>With the pace of yen declines moderate and a revival of inbound tourism turning the public's attention to the benefits of a weak currency, authorities see the threshold for yen-buying currency intervention fairly high compared with last year.</p>
      <p>But the more passive approach could change if hawkish comments by Powell drive up the dollar/yen at a faster speed, say three government officials with direct knowledge on Japan's currency policy.</p>
      <p>"Japan likely won't intervene as long as the moves are gradual," one of the officials said. "It's really about cracking down on speed limit violations."</p>
      <p>The yen lost about 1.5% against the dollar this month, much slower than a 4.8% dive seen in the three weeks to Oct. 21 last year when the dollar hit a 32-year high above 150 yen.</p>
      <p>POLITICS OF 150</p>
      <p>While authorities say that speed - rather than levels - is key in deciding when to step in, a breach of the 150 yen threshold could heighten political pressure on Prime Minister Kishida to act, the officials say.</p>
      <p>With his approval ratings sliding, Kishida on Tuesday unveiled a plan to cushion the blow from rising fuel costs driven in part by the weak yen.</p>
      <p>"When to intervene has always been an extremely political decision in Japan. Nowadays, it's the prime minister that ultimately makes the call," said Atsushi Takeuchi, a former BOJ official who was involved in Tokyo's market foray a decade ago.</p>
      <p>"Authorities usually don't have a specific line-in-the-sand in mind. But key thresholds like 150 are important for political reasons, as they are easy to understand."</p>
      <p>Japan's dilemma runs deep. Core inflation exceeded the central bank's 2% target for 16 straight months in July as firms continue to pass on higher import costs driven in part by the weak yen.</p>
      <p>Worried about hurting a fragile economy, the BOJ has stressed its resolve to keep interest rates ultra-low even as it decided last month to raise a cap on long-term bond yields.</p>
      <p>The BOJ's dovish tone, coupled with prospects that U.S. interest rates could stay higher for longer, has kept the dollar hovering around a nine-month high of 146.565 yen hit last week.</p>
      <p>But while the Fed and worries about China's economic woes could bring yen moves back into focus, there are doubts intervention would actually achieve much.</p>
      <p>"Authorities could smooth the pace of currency moves," said Daisaku Ueno, chief currency strategist at Mitsubishi UFJ Morgan Stanley Securities. "But they can't affect levels or trend, which depends largely on U.S. monetary policy."</p>
      <p>(Reporting by Leika Kihara and Tetsushi Kajimoto, Additional reporting by Kentaro Sugiyama and Yoshifumi Takemoto. Editing by Sam Holmes)</p>
    </div>
  },
  {
    id: 636,
    title: 'USD/JPY Forecast – US Dollar Continues to See Buyers on Dips',
    category: 'Forex',
    subCategory: ['USD', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The US dollar fell initially during the trading session on Tuesday, only to show signs of life by turning around again. All things being equal, this is a market that I think looks at the ¥145 level as a potential support level, which also had previously been a significant resistance barrier. Furthermore, the ¥145 level is an area where you would see a lot of psychology come into play as well.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 6:22 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692870372/ncx-blog-1167_qee97k.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
	    <h3>US Dollar vs Japanese Yen Technical Analysis</h3>
	    <p>The US dollar fell initially during the trading session on Tuesday, only to show signs of life by turning around again. All things being equal, this is a market that I think looks at the ¥145 level as a potential support level, which also had previously been a significant resistance barrier. Furthermore, the ¥145 level is an area where you would see a lot of psychology come into play as well.</p>
	    <p>Underneath, the ¥142.50 level is an area where we’ve seen some noise in the past, and then of course we have the 50-Day EMA coming into the picture right there as well. That could be your “floor in the market” as far as the overall uptrend is concerned. Keep in mind that it could be somewhat quiet over the next couple of days though, as we wait for Jerome Powell to speak on Friday, from the Jackson Hole Symposium. I think at this point, most traders are trying to figure out whether or not the Federal Reserve is actually going to stay tight for as long as they suggest.</p>	
    	<p>At this point, I think we probably have to look at this through the prism of finding value on dips, as the Bank of Japan continues to keep its monetary policy extraordinarily loose. At this point, I think the market is likely to continue to see the ¥147.50 level as a potential target. If we can break above there, then I think the next area will be looking to get to the ¥150 level.</p>	
	    <p>The interest rate differential alone is reason enough for the market to continue to see the US dollar do well against the Japanese in, but this is not just the US dollar that is going to see this, but perhaps the British pound, Australian dollar, New Zealand dollar, Canadian dollar, and so on. The Japanese yen will continue to be a bit of a punching bag for other currencies around the world, so the one thing that I do know that I won’t be doing any time soon is buying the Japanese yen against anything as the overall trend is firmly ensconced for that currency.</p>
    </div>
  },
  {
    id: 635,
    title: 'GBP/USD Forecast – British Pound Continues to See Basing Pattern',
    category: 'Forex',
    subCategory: ['GBP', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>In Tuesday’s trading, the British pound showed a measured upward movement, followed by a slight step back. This suggests a potential breakthrough above the 50-Day Exponential Moving Average. Now, we all know the market can be wild, so staying sharp and strategic is key.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 6:18 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692870118/ncx-blog-1166_ygayxf.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
    	<h3>British Pound vs US Dollar Technical Analysis</h3>
    	<p>In Tuesday’s trading, the British pound showed a measured upward movement, followed by a slight step back. This suggests a potential breakthrough above the 50-Day Exponential Moving Average. Now, we all know the market can be wild, so staying sharp and strategic is key. Notably, the pound has remained strong against the US dollar, even during a two-week consolidation phase. Today’s climb places us at a crossroads, on the verge of making important decisions.</p>
    	<p>Let’s dive into the analysis. The global trading community’s risk sentiment is a big player here. The pound’s steady climb hints at more rally chances. But it’s wise to be patient, waiting for a stronger and clearer surge upwards. If we can break last week’s highs, especially considering Friday’s trading, we might get closer to the big milestone of 1.30. This would boost and solidify the momentum we’ve been seeing.</p>	
    	<p>Taking a closer look, we see a clear uptrend line backed by the 200-Day EMA. This creates a strong support zone, giving more weight to the pound’s path. While a drop is possible, it doesn’t seem likely right now. Despite recent market ups and downs, the pound stands tall, holding its place in the complex currency world.</p>	
    	<p>With the market’s current volatility, a cautious and strategic approach is the smart play. Trends are swinging, so we need adaptable strategies. Keep in mind, the major trading hubs might not be as bustling due to the holiday mood. So, big market swings might not be the focus right now. Given this quieter time, it’s best to avoid extreme bullishness or pessimism.</p>
      <p>In the end, the British pound is moving cautiously upwards in the trading arena. Our immediate goal is to conquer that 50-Day EMA in this evolving market landscape. The pound’s solid rise against the US dollar is intriguing, and this temporary pause might just be a quick break before the next phase kicks in. As we navigate the market’s twists and turns, keep an eye on shifting risk feelings and key technical points. Especially in this festive time, a methodical approach coupled with readiness for sudden volatility will be your best assets for successfully navigating the trading world.</p>
    </div>
  },
  {
    id: 634,
    title: 'GBP/JPY Forecast – British Pound Gives Up Initial Gains',
    category: 'Forex',
    subCategory: ['GBP', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound initially rallied a bit during the session here on Tuesday, but gave back gains to pull back a bit and perhaps offer a little bit of value. At this point, it doesn’t mean that anything has changed, just simply that the market has gotten a little bit stretched.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 6:14 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692869955/ncx-blog-1165_iewblf.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
    	<h3>British Pound vs Japanese Yen Technical Analysis</h3>
    	<p>The British pound initially rallied a bit during the session here on Tuesday, but gave back gains to pull back a bit and perhaps offer a little bit of value. At this point, it doesn’t mean that anything has changed, just simply that the market has gotten a little bit stretched. With that being the case, I think you have to look at this through the prism of finding value and taking advantage of “cheap British pounds” when you get that opportunity.</p>
    	<p>Looking at this chart, I think you have a lot to take in, not the least of which is the fact that we are a little bit stretched. The question now is whether or not we are going to go sideways, or form some type of bullish flag. I think that is very likely the outcome here, so I’ll be looking to get long of this market closer to the ¥185 level. The 50-Day EMA is sitting right around the ¥181 level and rising, which I think would be a significant support level. Underneath there, the ¥180 level is also supported based upon the previous actions that we have seen, and of course the fact that it is a large, round, psychologically significant figure.</p>	
    	<p>In general, this is a market that I think continues to see a lot of noisy behavior, but we are very much in an uptrend, and therefore I just don’t see how you want to short this market anytime soon. This is especially due to the fact that the Bank of Japan is going to keep its monetary policy loose for a very long time from everything that I see, and the interest rate differential does pay you to sit on this pair. Furthermore, you can also look at this through the prism of a historical chart, and it does suggest that perhaps we could go all the way to the ¥200 level before it’s all said and done. Do not get me wrong, the ¥190 level will be a major barrier but there’s nothing on this chart that suggests that we can’t get through that level.</p>	
    </div>
  },
  {
    id: 633,
    title: 'AUD/USD Forecast – Australian Dollar Spikes',
    category: 'Forex',
    subCategory: ['AUD', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Australian dollar rallied significantly during the course of the trading session on Tuesday, as we have bounced from the 0.64 level. The 0.65 level above continues to offer a potential target for buyers, or at least people that are closing short positions.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 6:09 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692868877/ncx-blog-1164_xaiokj.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
    	<h3>Australian Dollar vs US Dollar Technical Analysis</h3>
	    <p>The Australian dollar rallied significantly during the course of the trading session on Tuesday, as we have bounced from the 0.64 level. The 0.65 level above continues to offer a potential target for buyers, or at least people that are closing short positions. Whether or not we can reach that level, then it’s likely that we can see quite a bit of selling pressure, assuming that we can even make that journey. Regardless, the Australian dollar continues to see reasons to short this market, mainly due to the fact that the Federal Reserve continues to be very tight with its monetary policy, and of course the Australian dollar is so highly levered to the mobile economy, and of course risk appetite.</p>
    	<p>The 50-Day EMA currently hangs around the 0.66 level, and is racing lower. That could be a potential technical resistance barrier that it’s going to come into the picture. All things being equal, I do think that the Australian dollar is a currency that you don’t necessarily want to own right now, especially against the US dollar. If we were to break down below the lows of the last week, then it’s possible that we could drop down to the 0.63 level, perhaps even lower than that.</p>	
    	<p>That being said, we have sold off quite drastically over the last couple of months, so a little bit of a recovery would not be completely out of the question. The action on Monday certainly had that attitude, so I’m more of a “fade the rally” type of situation. All things being equal, the market is likely to continue to be noisy in general, and therefore I think at this point you have to look at it through the prism of trying to find value in the greenback, due to the fact that the market has fallen so far. In other words, you don’t necessarily just jump in and start shorting after a huge move like we have seen. A little bit more of a measured short-term approach probably is called for, thereby taking advantage of little bits and pieces of short positions along the way.</p>	
    </div>
  },
  {
    id: 632,
    title: 'EUR/USD Forecast – Euro Gains but then Falls',
    category: 'Forex',
    subCategory: ['EUR', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Euro made a modest comeback in Tuesday’s trading session, showing signs of strength as it climbed past the 1.09 mark, but then faltered a bit. This upswing hints at a potential move towards the 50-Day EMA, hovering just below 1.10. Now, I’m not predicting a major downfall of the US dollar, but there’s a chance it might ease a bit against the Euro.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 5:30 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692868274/ncx-blog-1163_t6huoe.webp',
    content: <div className="blog-content">
      <p>In this article:</p>
    	<h3>Euro vs US Dollar Technical Analysis</h3>
	    <p>The Euro made a modest comeback in Tuesday’s trading session, showing signs of strength as it climbed past the 1.09 mark, but then faltered a bit. This upswing hints at a potential move towards the 50-Day EMA, hovering just below 1.10. Now, I’m not predicting a major downfall of the US dollar, but there’s a chance it might ease a bit against the Euro.</p>
    	<p>The 200-Day EMA is holding steady underneath, and it lines up neatly with an important upward trend line that has been significant for quite some time. Expect a bit of back-and-forth action, some ups and downs, but the ongoing consolidation we’ve seen makes sense. The market seems to be sticking to its established path, which could lead it to aim for the 1.1250 level.</p>	
	    <p>A U-turn and a breach below the 200-Day EMA and that trusty upward trend line could trigger a slide towards the 1.0650 mark, an area that has caused bounces before. Going below this might set the stage for more substantial declines. All things considered; I have a feeling the market will keep inching upward slowly. Why? Well, a lot of this feeling comes from traders thinking the Federal Reserve might take it easy on tightening its policies. But don’t forget about the European Central Bank and what it might do.</p>	
	    <p>Here’s the kicker: Jerome Powell and Christine Lagarde are scheduled to talk in Jackson Hole, Wyoming, at the end of the week. This event might give us a clearer sense of where the market is headed. Until then, I’d say the market might maintain its gentle upward drift. By the end of Friday’s session, we could have a better grasp of the situation. Right now, it looks like the path is leading toward a gradual rise.</p>
      <p>To wrap things up, the Euro’s recent moves tell us that it perked up a bit on Monday. Breaking past 1.09 is a good sign. And this could pave the way for a move towards 1.10 with the 50-Day EMA in sight. Despite the ups and downs, the market’s current trend makes sense, fitting within the expected pattern. The 200-Day EMA and that trusty trend line give us some solid footing. While things aren’t crystal clear, Powell and Lagarde’s speeches could steer us. Until then, let’s keep our eyes on the slow climb, though Friday could always throw a curveball. Time will tell in this pair.</p>
    </div>
  },
  {
    id: 631,
    title: 'Pound up as UK borrowing comes in lower than forecast',
    category: 'Forex',
    subCategory: ['Pound', 'UK', 'borrowing'],
    description: <div className="blog-desc">
      <p>The pound rose against the US dollar (GBPUSD=X) and the euro (GBPEUR=X) on Tuesday after new data showed public sector borrowing in the UK slowed in July.</p>
    </div>,
    authorName: 'Angela Barnes',
    authorurl: 'https://www.yahoo.com/author/angela-barnes/',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 4:38 PM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692867936/ncx-blog-1162_i5nrvu.webp',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>The pound rose against the US dollar (GBPUSD=X) and the euro (GBPEUR=X) on Tuesday after new data showed public sector borrowing in the UK slowed in July.</p>
    	<p>Sterling was up against the USD by 0.08% to $1.27, while the pound also edged higher against the euro, up by 0.18% to €1.17.</p>	
    	<p>The budget deficit between April and July 2023 was £56.6bn, according to the Office for National Statistics (ONS).</p>	
    	<p>The borrowing figure was some £11.3bn less than the Office for Budget Responsibility (OBR) had forecast it to be in March.</p>
      <p>However, whilst it was below the OBR forecast, it was still £3bn more than last year’s figure for the same month.</p>
      <p>“The pound has been a touch stronger against the euro so far today, extending its rally to more than 1.5% since mid-August, and trading around its highest level in five weeks. News of July’s smaller-than-expected budget deficit may partly be buoying GBP, as this could provide more wiggle room for the UK government to cut taxes, and therefore support growth, ahead of the next general election,” said Matthew Ryan, head of market strategy at financial services firm Ebury.</p>
      <p>“That said, ongoing concerns surrounding the state of the Chinese economy continue to largely dominate the narrative in markets. Unlike the euro area, Britain is not overly dependent on demand from Asia’s largest economy, so recent soft China data, and worries over the health of the country’s property sector, appear to be providing the GBP/EUR pair with a further leg up,” he added.</p>
      <p>Giles Coghlan, chief market analyst, consulting for HYCM, said: "With borrowing figures rising less than anticipated, the GBP’s show of strength against both the Euro and the Dollar is a sign that inflation is easing, slowly but surely.</p>
      <p>“However, interest rates continue to rise and expectations of a mild recession remain – investors should note that inflation figures are expected to rise again when August’s figures are released next month, which could devalue the pound against the dollar.”</p>
      <p>Coghlan further noted that with investors amassing an extreme long GBP positioning, any signs of slowing growth and worries over a deeper recession could see stagflation fears sending the GBP sharply lower.</p>
      <p>“The market will be carefully watching tomorrow's PMI release. If this comes in below 50 for the services and below 44 for the manufacturing, expect the GBP to sell off sharply tomorrow," he added.</p>
      <h3>HSBC bearish on GBP</h3>
      <p>Despite the pound’s move higher, HSBC has been bearish on the currency with the bank’s head of European foreign exchange research, Dominic Bunning, saying this week that weak retail sales for July published on Friday raised alarm bells over the sustainability of its rally, which hit $1.31 in July.</p>
      <p>“The consumer resilience that we saw helping to drive the pound higher earlier this year appears to be fading slightly earlier than we expected," he said.</p>
      ...
      <p>Traders will now be turning their attention to Wednesday’s S&P Global PMI surveys of the manufacturing and services sectors for further UK economic indicators.</p>
      <p>Manufacturing in July is expected to rise to 46.2 and services to fall to 51.2, according to IG analyst Chris Beauchamp.</p>
    </div>
  },
  {
    id: 630,
    title: 'Ex-BOJ official predicts no yen intervention until breach of 150 threshold',
    category: 'Forex',
    subCategory: ['BOJ', 'YEN', 'Japan'],
    description: <div className="blog-desc">
      <p>TOKYO (Reuters) - Japan will forgo intervening in the market unless the yen plunges past 150 to the dollar and becomes a huge political headache for premier Fumio Kishida, said a former central bank official who was involved in Tokyo's market foray a decade ago.</p>
    </div>,
    authorName: 'Leika Kihara',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'August 22, 2023 - 11:05 AM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1692867628/ncx-blog-1161_al9hd5.webp',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>By Leika Kihara</p>
    	<p>TOKYO (Reuters) - Japan will forgo intervening in the market unless the yen plunges past 150 to the dollar and becomes a huge political headache for premier Fumio Kishida, said a former central bank official who was involved in Tokyo's market foray a decade ago.</p>	
    	<p>The dollar stood at 146.125 yen on Tuesday, staying near a nine-month high of 146.565 hit last Thursday.</p>	
    	<p>When the dollar broke above the 145-yen line that triggered intervention last year, speculation began mounting that Tokyo would soon step into the market to support its currency.</p>
      <p>"Authorities usually don't have a specific line-in-the-sand in mind. But key thresholds like 150 are important for political reasons, as they are easy to understand," said Atsushi Takeuchi, who was head of the BOJ's foreign exchange division when Tokyo intervened back in 2010-2012.</p>
      <p>The public's mood is key to when authorities intervene due to the strong attention Japanese firms and households place on yen moves, said Takeuchi.</p>
      <p>But anxiety over the weak yen appears less than a year ago as households are becoming accustomed to rising prices, he said.</p>
      <p>The benefits of a weak yen are also becoming clearer due to Japan's re-opening of borders, which is reviving inbound tourism and domestic service-sector firms, he added.</p>
      <p>"When to intervene has always been an extremely political decision in Japan. Nowadays, it's the prime minister that ultimately makes the call," Takeuchi told Reuters on Tuesday.</p>
      <p>"Public discontent over the weak yen isn't escalating to a scale seen last year," he said. "I don't think Kishida is under huge pressure to respond."</p>
      <p>But authorities could intervene if the yen speeds up its pace of declines and breaches 150 to the dollar, he said.</p>
      <p>Before stepping in, authorities will likely offer verbal warnings and conduct rate checks to buy time in hope markets will correct themselves, Takeuchi said.</p>
      <p>"Even if intervention isn't imminent, as policymakers you don't want to appear as if you're indifferent to market moves."</p>
      <p>Last year's sharp yen falls boosted import costs for fuel and food, hitting households yet to see wages rise much. That prompted Tokyo to conduct a rare operation to prop up the yen.</p>
      <p>Japan historically focused on preventing sharp yen rises that hurt its export-reliant economy. Takeuchi took part in several yen-selling intervention from 2010 to 2012. He is now chief research fellow at Ricoh Institute of Sustainability and Business.</p>
      <p>Under Japanese law, the government holds jurisdiction over currency policy. The BOJ serves as an agent of the Ministry of Finance, which decides when to intervene.</p>
      <p>(Reporting by Leika Kihara; Editing by Simon Cameron-Moore)</p>
    </div>
  },
  {
    id: 629,
  ...
  },
{
  ...
  },
  {
    ...
    category: 'Forex',
    subCategory: ['Pound', 'Dollar', 'Forecast'],
    description: <div className="blog-desc">
      <p>The pound (GBPUSD=X) has rallied significantly over the last several days, climbing to a 10-month high against the US dollar.</p>
    </div>,
    authorName: 'Pedro Goncalves',
    authorurl: 'https://www.yahoo.com/author/pedro-goncalves',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 14, 2023 - 1:08 PM',
    cover: 'https://ncx.cx/images/ncx-blog-346.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p>The pound (GBPUSD=X) has rallied significantly over the last several days, climbing to a 10-month high against the US dollar.</p>
      <p>Sterling hit $1.2546 on Friday morning, the highest since last June, as the dollar dropped on the foreign exchange markets on hopes that the US Federal Reserve could stop lifting interest rates soon.</p>
      <p>Fawad Razaqzada, market analyst at City Index and FOREX.com, said: “The US dollar continued to weaken on Thursday, mostly against currencies where the central bank still remains hawkish, or the economic backdrop is improving.</p>
      <p>The dollar has come under renewed pressure after more signs emerged that inflation has peaked.</p>
      <p>“Traders are thus betting that the Fed will stop hiking interest rates, and soon it may even start loosening its policy again.”</p>
      <p>The pound was also supported by a speech from Huw Pill, chief economist at the Bank of England, who said the path of inflation “may be bumpier than expected".</p>
      <p>Victoria Scholar, head of investment at Interactive Investor, said: “The pound has hit a 10-month high against the US dollar while EUR/USD has rallied to the highest level since April 2022.</p>
      <p>“Cable (GBP/USD) is up over 3.6% year-to-date and is up over 12% in 6 months since the fiscal fiasco around the mini-budget last September which heavily punished the British currency.</p>
      <p>“Since the lows, the pound has been steadily regaining ground while the US dollar depreciates as traders price in the growing expectation that we are near the peak of the Fed’s rate hiking cycle. After last year’s bull run for the greenback driven by aggressive monetary tightening in the US, 2023 has seen King Dollar lose its crown with the euro and the pound appreciating significantly against it.</p>
      <p>“However there is still a long way to go to revisit the levels of dollar weakness seen at the end of 2020 and the beginning of 2021.”</p>
      <p>Sterling has gained almost once cent this week, and is on track for its fifth weekly gain against the dollar in a row.</p>
    </div>
  },
  {
    id: 336,
    ...
    category: 'Forex',
    subCategory: ['Euro', 'Dollar', 'Fed-Cut'],
    description: <div className="blog-desc">
      <p>(Bloomberg) -- The euro jumped to its highest level in more than a year as the dollar dived against its major developed market peers, fueled by increasing market expectations that a worsening US economic situation will prompt the Federal Reserve to cut interest rates later this year.</p>
    </div>,
    authorName: 'Aline Oyamada and Naomi Tajitsu',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 13, 2023 - 10:37 PM',
    cover: 'https://ncx.cx/images/ncx-blog-347.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p>(Bloomberg) -- The euro jumped to its highest level in more than a year as the dollar dived against its major developed market peers, fueled by increasing market expectations that a worsening US economic situation will prompt the Federal Reserve to cut interest rates later this year.</p>
      <p>Europe’s common currency rose as much as 0.7% to $1.1068, a level last seen in April 2022, while the British pound touched a year-to-date high of $1.2537. The New Zealand and Australian dollars were the biggest gainers along with the Norwegian krone and the Swiss franc, while the Bloomberg dollar index declined as much as 0.7% to its lowest mark since early February.</p>
      <p>The moves gained additional momentum in the US morning after producer price index data that showed reduced inflationary pressures. Investors had already turned more confident the Fed will cut interest rates later this year after data Wednesday showed US consumer-price inflation decelerated more than expected and the minutes of the central bank’s March meeting revealed policymakers scaled back expectations for rate hikes this year after a series of bank collapses roiled markets.</p>
      <p>“There’s a lot of focus on the probability that the Fed could be cutting by the end of the year,” said Jane Foley, a senior foreign-exchange strategist at Rabobank. “The market is celebrating that.”</p>
      <p>The Bloomberg Dollar Spot Index has fallen more than 10% since reaching an all-time high in September, and after a short-lived rally earlier this year it resumed its downward trend in mid-March, when the collapse of three US lenders sparked fears of a global banking crisis. Tighter financial conditions have led investors to rethink their expectations for interest rates around the world, paring bets on aggressive tightening by the Fed and its main counterparts.</p>
      <p>The Australian dollar spiked as much as 1.6% to 0.6797 against the dollar, the highest level since Feb. 24. The Aussie was supported by domestic labor data highlighting economy’s resilience in the face of aggressive rate hikes.</p>
      <p>Swap rates tied to Fed meeting dates suggest that officials are more likely than not to raise rates by another quarter point at their May meeting, but then proceed to lower the benchmark by year-end to a level more than half a point below the current effective fed funds rate.</p>
      <p>The dollar weakness has lifted investor sentiment toward the euro, with three-week risk reversals versus the dollar — a tenor that captures the next monetary policy decisions by the Fed and the European Central Bank — reaching the least bearish levels since February 2022.</p>
      <p>“The markets are expecting further divergence between the hawkish ECB and the peaking Fed,” said Credit Agricole foreign-exchange strategist Valentin Marinov. “That said, I think that the divergence has reached extreme proportions,” noting that he sees growing downside risks to the euro versus the dollar.</p>
      <p>--With assistance from Vassilis Karamanis and Anya Andrianova.</p>
    </div>
  },
  {
    id: 337,
  ...
  },
  {
    ...
    subCategory: ['AUD', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Australian dollar has rallied a bit during the trading session on Wednesday, showing signs of life again as we continue to see a lot of noise around the 0.67 level. The 0.67 level is an area that’s been important multiple times in the past, and therefore it’ll be interesting to see how this market plays out in the current environment.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 12, 2023 - 4:19 PM',
    cover: 'https://ncx.cx/images/ncx-blog-355.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p><strong>Australian Dollar vs US Dollar Technical Analysis</strong></p>
      <p>The Australian dollar has rallied a bit during the trading session on Wednesday, showing signs of life again as we continue to see a lot of noise around the 0.67 level. The 0.67 level is an area that’s been important multiple times in the past, and therefore it’ll be interesting to see how this market plays out in the current environment.</p>
      <p>The Australian dollar is highly sensitive to risk appetite and global growth, so you should pay close attention to both of those. The Aussie dollar is highly correlated with the commodity markets, so that is something worth paying attention to as well, as they will have a major influence on where this pair goes.</p>
  ...
  {
    id: 345,
    title: 'GBP to USD Forecast – British Pound Runs Into Resistance Barrier',
    category: 'Forex',
    subCategory: ['GBP', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound has rallied a bit during the trading session, as we continue to see a lot of noise above the 1.24 level. The market has attempted to break above there, but it also is starting to show signs of exhaustion. Ultimately, this is a situation where we are getting overbought, so there is the possibility that we pull back significantly. If we break down below the hammer from the Monday session, then the market is likely to go looking to reach the 50-Day EMA, and then possibly down to the 200-Day EMA.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 11, 2023 - 5:09 PM',
    cover: 'https://ncx.cx/images/ncx-blog-356.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p><strong>British Pound vs US Dollar Technical Analysis</strong></p>
      <p>The British pound has rallied a bit during the trading session, as we continue to see a lot of noise above the 1.24 level. The market has attempted to break above there, but it also is starting to show signs of exhaustion. Ultimately, this is a situation where we are getting overbought, so there is the possibility that we pull back significantly. If we break down below the hammer from the Monday session, then the market is likely to go looking to reach the 50-Day EMA, and then possibly down to the 200-Day EMA.</p>
      <p>The British pound course has been one of the better performing currencies around the world this year, so therefore it’s not a huge surprise to see that it is trying to break out. Whether or not it can remains to be seen, but at the very least we would need to see a daily close above the 1.25 level. If we get that, then it’s possible that the market is looking to the 1.2750 level above. That being said, we need to see some type of fundamental reason, or massive US dollar so often make that happen. While the US dollar has been sold off rather stringently as of late, it is oversold at this point.</p>
      <p>Ultimately, this is a situation where the US dollar will be the main driver, so therefore it’s likely that we will continue to see a lot of volatility, as traders around the world continue to think about the questions of global growth, and of course whether or not safety will be crucial. The Federal Reserve is likely to continue raising interest rates at the next meeting in May, but the question is whether or not they keep raising after that. They are ready to deal with inflation, and therefore people are expecting the Bank of England to remain tight, but at the end of the day, the Federal Reserve has been screaming from the mountain tops that they are going to stay tight regardless. The question now is whether or not we are breaking out of the range that I have marked on the chart, or if we are simply at the top of the range and getting ready to pull back.</p>
    </div>
  },
  {
    id: 346,
    title: 'GBP/JPY Forecast – British Pound Continues to Reach Toward Top of Range',
    category: 'Forex',
    subCategory: ['GBP', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound has rallied a bit during the trading session on Tuesday to reach the ¥166 region. This is an area where we have seen some selling pressure recently, so it will be difficult to break above there. That being said, if we can take out that massive “wipeout candlestick” from December, then we could go toward the ¥169 level. A short-term pullback does make a certain amount of sense, but I think there are plenty of reasons to think that there are buyers underneath. For example, the 50-Day EMA which sits just below the ¥163 level and is rallying higher.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 11, 2023 - 5:04 PM',
    cover: 'https://ncx.cx/images/ncx-blog-357.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p><strong>British Pound vs Japanese Yen Technical Analysis</strong></p>
      <p>The British pound has rallied a bit during the trading session on Tuesday to reach the ¥166 region. This is an area where we have seen some selling pressure recently, so it will be difficult to break above there. That being said, if we can take out that massive “wipeout candlestick” from December, then we could go toward the ¥169 level. A short-term pullback does make a certain amount of sense, but I think there are plenty of reasons to think that there are buyers underneath. For example, the 50-Day EMA which sits just below the ¥163 level and is rallying higher.</p>
      <p>That being said, it does look like the market is trying to do everything he can to rally, so I think this remains a bit of a “buy on the dip” type of market as we continue see the Japanese yen get hammered. As long as the Bank of Japan continues its yield curve control scheme, it will put downward pressure on the Japanese yen. Ultimately, this is a market that I think continues to see a lot of noisy behavior, but we are a bit stretched at the moment so a little bit of a pullback does make a certain amount of sense.</p>
      <p>All things being equal, this is a market that I think continues to make a lot of noise, but you certainly would struggle finding a reason to short this market with any type of gusto or super conviction. Alternatively, this is a situation where if you are patient enough, you should be able to find plenty of value going forward.</p>
    </div>
  },
  {
    id: 347,
    title: 'EUR/USD Forecast – Euro Continues to See Resistance in The Same Area',
    category: 'Forex',
    subCategory: ['EUR', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Euro initially rallied during the trading session on Tuesday, to reach the 1.09 level. This is an area that begins a significant amount of resistance all the way to the 1.10 level, as we have seen recently. The question at this point is going to be whether or not we are forming some type of double top, and if the US dollar is going to start to strengthen again.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 11, 2023 - 5:00 PM',
    cover: 'https://ncx.cx/images/ncx-blog-358.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p><strong>Euro vs US Dollar Technical Analysis</strong></p>
      <p>The Euro initially rallied during the trading session on Tuesday, to reach the 1.09 level. This is an area that begins a significant amount of resistance all the way to the 1.10 level, as we have seen recently. The question at this point is going to be whether or not we are forming some type of double top, and if the US dollar is going to start to strengthen again.</p>
      <p>Even if we did break down from here, it doesn’t necessarily mean that the Euro is going to fall apart. After all, you would have to deal with the 1.08 level as potential support, right along with the 50-Day EMA indicator shortly thereafter. After that, then you are talking about the 200-Day EMA which is right around the crucial and psychologically important 1.05 level. In other words, there are a lot of things that can happen on the way down, but at this point, it looks like the Euro is going to struggle to continue going higher. The question now is whether or not this will become an important double top.</p>
      <p>A lot of this will more likely than not come down to risk appetite, as we have seen multiple times in this pair. Just above, we have the 1.10 level which is a large, round, psychologically significant figure, and an area where a lot of people would be paying close attention to the Euro in general. If we were to take out that level significantly, then it opens up a much bigger move to the upside, perhaps reaching all the way to the 1.1250 level.</p>
      <p>A lot of things have happened over the last couple weeks it could give us a situation where there are so many different outcomes are possible, but at this point I would be very cautious about trying to buy this market, as there is so much in the way of overhead selling pressure. Alternatively, a lot of this will come down to whether or not people are feeling like global growth continues, or if it is going to be a situation where people start running back to the safety of the US dollar.</p>
    </div>
  },
  {
    id: 348,
    title: 'AUDUSD Forecast – Australian Dollar Gives Up Some of His Gains',
    category: 'Forex',
    subCategory: ['AUD', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Australian dollar has rallied a bit during the trading session on Tuesday, breaking toward the 0.67 level before selling off again. Ultimately, this is a market that I think continues to see a lot of overhead pressure, and this of course makes quite a bit of sense that we would see this market drought, due to the fact that there has been so much noise in the general vicinity, and of course all of the fundamental reasons that you have to think about the Australian dollar.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 11, 2023 - 4:54 PM',
    cover: 'https://ncx.cx/images/ncx-blog-359.jpg',
    content: <div className="blog-content">
      <h3>In this article:</h3>
      <p><strong>Australian Dollar vs US Dollar Technical Analysis</strong></p>
      <p>The Australian dollar has rallied a bit during the trading session on Tuesday, breaking toward the 0.67 level before selling off again. Ultimately, this is a market that I think continues to see a lot of overhead pressure, and this of course makes quite a bit of sense that we would see this market drought, due to the fact that there has been so much noise in the general vicinity, and of course all of the fundamental reasons that you have to think about the Australian dollar.</p>
      <p>The Australian dollar of course is levered to the commodity markets, which by extension are levered to global growth. With this being the case, the market is likely to see a lot of hesitation, as inflation is raging across the world and while it can be good for commodities, the reality is we are also seeing a lack of growth. A lack of growth obviously will drive down demand for a lot of the assets to come out of Australia such as iron, aluminum, copper, etc. Another thing to keep in mind is that the Australian dollar is highly levered to the Chinese economy, so you need to pay close attention to it</p>
      <p>If we do break above the 0.67 level, then we could see a run toward the 50-Day EMA, which is sloping lower and will more likely than not cause a bit of technical resistance. After that, we have the 200-Day EMA which is near the 0.68 level, which is the top of the previous range. The 200-Day EMA is obviously an important technical indicator that people pay attention to, so that of course is going to come into the picture as well. All things being equal, this is a market that I think you continue to fade rallies, and if we can break down below the 0.6550 level, it opens up quite a bit more selling, down to the 0.64 level, followed by the 0.63 level after that. Ultimately, the US dollar course is a currency that people run toward in times of fear, which I think is part of what we are seeing.</p>
    </div>
  },
  {
    id: 349,
    ...
    category: 'Forex',
    subCategory: ['Rupee', 'USD', 'falls'],
    description: <div className="blog-desc">
      <p>MUMBAI (Reuters) - The Indian rupee declined past the key psychological mark of 82 per dollar on Tuesday on likely corporate outflows and importer demand for the greenback, traders said.</p>
    </div>,
    authorName: 'Anushka Trivedi',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 11, 2023 - 6:49 AM', 
    cover: 'https://ncx.cx/images/ncx-blog-360.jpg',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>By Anushka Trivedi</p>
    	<p>MUMBAI (Reuters) - The Indian rupee declined past the key psychological mark of 82 per dollar on Tuesday on likely corporate outflows and importer demand for the greenback, traders said.</p>	
    	<p>The rupee finished at 82.1250 to the dollar, having declined up to 82.15 during the session. It closed at 81.98 in on Monday.</p>	
    	<p>Persistent dollar-buying when the dollar index is weaker indicates there is an outflow, a trader said.</p>
      <p>However, dealers couldn't identify the nature of the outflow. They also cited importer demand through the session.</p>
      <p>A move towards 82.20 could set the rupee for further weakness, they said.</p>
      <p>So far, companies and bankers have had a bias towards rupee appreciation on improving macro economic fundamentals and carry trade appeal.</p>
      <p>"We think most investors are yet to price in the structural changes in the current account deficit (CAD) over the last few quarters," Anubhuti Sahay, head of South Asia Economic Research (India), Standard Chartered Bank wrote.</p>
      <p>"A sharp pick-up in services exports, increased smartphone exports and savings in the oil import bill... have likely altered India's CAD permanently."</p>
      <p>This week the rupee would take cues from the India and U.S. inflation data, both, due Wednesday, with the former considered more crucial by traders.</p>
      <p>The U.S. data will be instrumental in the Federal Reserve's decision on whether to raise rates at its May meeting, which is leaning towards a 25 basis point (bps) hike following the U.S. jobs report, futures showed.</p>
  ...
  {
    id: 350,
    title: 'GBP to USD Forecast – British Pound Consolidates',
    category: 'Forex',
    subCategory: ['GBP', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound has gone back and forth during the trading session on Monday, as we continue to see a lot of volatility. At this point, it looks like the market is trying to figure out what to do next, but quite frankly this is a situation where we have dug into a major resistance barrier between the 1.24 level in the 1.25 level. Ultimately, we have to ask questions as to whether or not the US dollar is going to strengthen or weaken, and of course we have to determine whether or not risk appetite will still be out there. After all, there are a lot of different moving pieces at the moment, but we also need to keep in mind that there are multiple reasons why the British pound or the US dollar my strengthen.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 10, 2023 - 5:14 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-361.jpg',
    content: <div className="blog-content">
	    <h3>In this article:</h3>
    	<p><strong>British Pound vs US Dollar Technical Analysis</strong></p>
    	<p>The British pound has gone back and forth during the trading session on Monday, as we continue to see a lot of volatility. At this point, it looks like the market is trying to figure out what to do next, but quite frankly this is a situation where we have dug into a major resistance barrier between the 1.24 level in the 1.25 level. Ultimately, we have to ask questions as to whether or not the US dollar is going to strengthen or weaken, and of course we have to determine whether or not risk appetite will still be out there. After all, there are a lot of different moving pieces at the moment, but we also need to keep in mind that there are multiple reasons why the British pound or the US dollar my strengthen.</p>	
    	<p>Looking forward, if we can break above the 1.25 level, then it is likely that this market takes off. If it does, then the 1.2750 level might be the next target, perhaps even to the 1.30 level given enough time. Ultimately, I think this is a scenario where this is going to be about risk appetite more than anything else. The Federal Reserve has at least one more interest rate hike ahead of it, so now the question is going to be whether or not there are more than just one.</p>	
    	<p>Recently, the 50-Day EMA has broken above the 200-Day EMA, showing signs of strength in what is typically known as a “golden cross.” That being said, the market is more of a “buy on the pullback” type of market going forward, therefore it looks like looking at this chart, this is a market that is going to continue to see plenty of volatility, but I think given enough time we probably have to make bigger decisions. A breakdown below the 1.2350 level opens up the possibility of a move down to the 50-Day EMA, which is closer to the 1.22 level. Underneath there, then you have the 200-Day EMA that comes into the picture as well, which of course will typically attract a lot of attention. With this being the case, I think you need to be very cautious with the position size, as we are about to make a bigger move.</p>
    </div>
  },
  {
    id: 351,
    title: 'GBP/JPY Forecast – British Pound Rallies Toward Top of Range Against Japanese Currency',
    category: 'Forex',
    subCategory: ['GBP', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound initially pulled back just a bit during the trading session on Monday, but then turned around to show signs of strength as the Japanese yen started to lose strength against currencies across the board. It’s worth noting that we are getting close to the top of the overall range, with the ¥166 level offering a significant resistance barrier. That being said, the market is more likely than not going to be very noisy and have to deal with a lot of selling pressure just above.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 10, 2023 - 5:09 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-362.jpg',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p><strong>British Pound vs Japanese Yen Technical Analysis</strong></p>
    	<p>The British pound initially pulled back just a bit during the trading session on Monday, but then turned around to show signs of strength as the Japanese yen started to lose strength against currencies across the board. It’s worth noting that we are getting close to the top of the overall range, with the ¥166 level offering a significant resistance barrier. That being said, the market is more likely than not going to be very noisy and have to deal with a lot of selling pressure just above.</p>	
    	<p>If we do pull back from here, the 50-Day EMA sits near the ¥162.50 level, and has recently just crossed above the 200-Day EMA. Ultimately, this is a market that looks as if it will find plenty of buyers on dips, based upon the recent action that we have seen in this market, and therefore I think it’s more or less going to be a situation where you will be looking for buying opportunities. However, the market is likely to continue to see a lot of risk appetite moves, so I think at this point you will probably have to count on a lot of volatility more than anything else. With this, I think you need to be cautious with your position sizing, but if and when we can break above the shooting star that we formed last week, then I think the market has more of a shot of going “buy-and-hold.”</p>	
    	<p>If we were to break down below the moving averages, then it opens up the possibility of a move to the ¥160 level underneath, which is an area that is previous support, and of course is a large, round, psychologically significant figure that will make for good headlines. However, it’s probably worth noting that the most recent pullback was much shallower than the previous one suggesting that more pressure is building to the upside than anything else in this pair. If interest rates start to rise, keep in mind that the Bank of Japan continues its yield curve control policy, thereby putting a lot of pressure on the Japanese yen.</p>
    </div>
  },
  {
    id: 352,
    title: 'EUR/USD Forecast – Euro Gives Up Early Gain',
    category: 'Forex',
    subCategory: ['EUR', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Euro initially tried to rally during the trading session on Monday but gave back gains above the 1.09 level as we continue to see a lot of overhead resistance. The market has seen quite a bit of noise recently, so it does make a certain amount of sense that the Euro could struggle a bit. Ultimately, I think that we are in the midst of potentially trying to form some type of double top, perhaps showing just how difficult it’s going to be to get above the 1.10 level. If we do break down below the 1.08 level, then it’s very likely that we will continue going lower. I understand that the 50-Day EMA is coming into the picture, as it is near the 1.0750 level and rising.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 10, 2023 - 5:04 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-363.jpg',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p><strong>Euro vs US Dollar Technical Analysis</strong></p>
    	<p>The Euro initially tried to rally during the trading session on Monday but gave back gains above the 1.09 level as we continue to see a lot of overhead resistance. The market has seen quite a bit of noise recently, so it does make a certain amount of sense that the Euro could struggle a bit. Ultimately, I think that we are in the midst of potentially trying to form some type of double top, perhaps showing just how difficult it’s going to be to get above the 1.10 level. If we do break down below the 1.08 level, then it’s very likely that we will continue going lower. I understand that the 50-Day EMA is coming into the picture, as it is near the 1.0750 level and rising.</p>	
    	<p>If we break down below the 50-Day EMA, then it would make a certain amount of sense that we would see a bigger drop down to the 200-Day EMA, which sits right around the 1.0550 level, perhaps down to the 1.05 level. Ultimately, this is a market that I think is a situation where a lot of buyers would come back into this picture. If we were to break down below the 1.05 level, then the market is likely to drop rather significantly from there, as it has been a rather important support level recently.</p>	
    	<p>This is a situation where the sellers have a lot to prove, but quite frankly the market is likely to continue to see a lot of significant volatility as we continue to see a lot of questions around the world about global growth, and of course the Federal Reserve. The Federal Reserve is likely to raise interest rates at the next meeting in early May, but the question now is whether or not they will continue to raise rates. While the European Central Bank is almost certainly going to be a situation where we are probably going to see a lot of upward pressure on interest rates, but given enough time I think we’ve got a situation where risk aversion could send the US dollar into a much stronger position, but right now I think we’ve got a lot of choppiness so keep your position size reasonable.</p>
    </div>
  },
  {
    id: 353,
    title: 'AUDUSD Forecast – Australian Dollar Sits at Bottom of Current Range',
    category: 'Forex',
    subCategory: ['AUD', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The Australian dollar has rallied just a bit during the trading session on Monday, which of course was always going to be a bit quiet due to the fact that so many countries around the world still had banking holidays from the Easter weekend. That being said, the market is likely to continue to see a lot of noisy and choppy behavior regardless, as the markets have to deal with so many moving pieces at the same time. Keep in mind that the market has been having to try to figure out what the Federal Reserve is going to do, as there is still an argument as to whether or not this next interest rate hike is the last one or if there’s going to be another one after that.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 10, 2023 - 4:59 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-364.jpg',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p><strong>Australian Dollar vs US Dollar Technical Analysis</strong></p>
    	<p>The Australian dollar has rallied just a bit during the trading session on Monday, which of course was always going to be a bit quiet due to the fact that so many countries around the world still had banking holidays from the Easter weekend. That being said, the market is likely to continue to see a lot of noisy and choppy behavior regardless, as the markets have to deal with so many moving pieces at the same time. Keep in mind that the market has been having to try to figure out what the Federal Reserve is going to do, as there is still an argument as to whether or not this next interest rate hike is the last one or if there’s going to be another one after that.</p>	
    	<p>Furthermore, we have to worry about the idea of whether or not there’s going to be global growth, and quite frankly it’s a situation where the reaction by the Australian dollar is going to highly mimic what we are seeing in the commodities market as global growth demands commodity consumption. That being said, it’s worth noting that the Reserve Bank of Australia chose to sit tight during the last interest rate decision, so it does suggest that the Australians will be at the end of their interest rate hiking cycle.</p>	
    	<p>The 50-Day EMA sits right around the 0.6750 level and is starting to drop. That will be a technical resistance barrier, as the market continues to see a lot of negativity over the longer term. That being said, I do think that if we break above here, then you could see a move looking toward the 200-Day EMA, which is just above the 0.68 level, an area that has been important multiple times. That being said, it’s probably worth noting that in limited trading on Monday, the rally did run out of momentum, and we gave back about half of the gain by the time we got to the United States trading.</p>
    </div>
  },
  {
    id: 354,
    title: 'USD/JPY Weekly Forecast – US Dollar Bounces After Initial Sell-off for the Week',
    category: 'Forex',
    subCategory: ['USD', 'JPY', 'Forecast'],
    description: <div className="blog-desc">
      <p>The US dollar initially fell during the trading week to reach down to the ¥131 level, an area that of course is a large, round, psychologically significant figure and an area where we have seen support multiple times. The market turned right back around to show signs of life, and we ended up forming a hammer-shaped candlestick for the week. That being said, this is a market that has a lot of noise around it, and of course, you have to keep an eye on several moving pieces.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 7, 2023 - 6:14 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-365.jpg',
    content: <div className="blog-content">
	    <h3>In this article:</h3>
	    <p><strong>US Dollar vs Japanese Yen Weekly Technical Analysis</strong></p>
    	<p>The US dollar initially fell during the trading week to reach down to the ¥131 level, an area that of course is a large, round, psychologically significant figure and an area where we have seen support multiple times. The market turned right back around to show signs of life, and we ended up forming a hammer-shaped candlestick for the week. That being said, this is a market that has a lot of noise around it, and of course, you have to keep an eye on several moving pieces.</p>	
    	<p>The first thing you need to keep an eye on is the fact that the Bank of Japan has its yield curve control in full effect, meaning that they are willing to print unlimited yen in order to keep the 10-year JGB interest rate at 50 basis points or lower. This is exactly what caused so much trouble for the Japanese last year, but now the rates are starting to fall across the world, and it has released some of that pressure. On the other hand, the Federal Reserve continues to have its hands full as we worry about inflation in the United States, and of course, traders are betting in both directions at the moment as to what the Federal Reserve is going to do. Ultimately, most traders are starting to come around to the idea that the Fed is going to loosen monetary policy, and the Fed Funds Rate is starting to price in an astronomical amount of interest rate cuts later this year. Whether or not that actually happens is a completely different question of course, and the Federal Reserve of course vehemently denies this.</p>	
	    <p>That being said, if we break down below the ¥131 level, then it’s likely that we could go down to the ¥127.50 level, an area that has formed a bit of a double bottom recently. If we were to break down below there, then the market will certainly fall quite drastically from there. On the other hand, if we turn around and take out the ¥134 level, then we could go looking to the ¥136 level, but it would take a bit of effort to get there. I suspect that the next couple of weeks are going to continue to be noisy.</p>
    </div>
  },
  {
    id: 355,
    title: 'GBP to USD Weekly Forecast – British Pound Running Into Resistance',
    category: 'Forex',
    subCategory: ['GBP', 'USD', 'Forecast'],
    description: <div className="blog-desc">
      <p>The British pound has rallied significantly during the course of the week, piercing the 1.25 level. This is an area that obviously is psychologically important, but it should also be pointed out that we are in the midst of a cluster in the past where there had been a lot of trading, which extends all the way to the 1.2660 level. Breaking through all of that would be very bullish, and would send the British pound into a bullish phase, perhaps all the way to the 1.37 level.</p>
    </div>,
    authorName: 'Christopher Lewis',
    authorurl: '',
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Apr 7, 2023 - 5:57 PM', 
    cover: 'https://ncx.cx/images/ncx-blog-366.jpg',
    content: <div className="blog-content">
	    <h3>In this article:</h3>
    	<p><strong>British Pound vs US Dollar Weekly Technical Analysis</strong></p>
    	<p>The British pound has rallied significantly during the course of the week, piercing the 1.25 level. This is an area that obviously is psychologically important, but it should also be pointed out that we are in the midst of a cluster in the past where there had been a lot of trading, which extends all the way to the 1.2660 level. Breaking through all of that would be very bullish, and would send the British pound into a bullish phase, perhaps all the way to the 1.37 level.</p>	
    	<p>The British pound has been one of the better currencies to own this year, and at this point, it’ll be interesting to see if that changes anytime soon. After all, we are starting to see serious concerns about global growth and inflation, so risk appetite is going to be a bit of a moving target. Underneath, the 50-Week EMA sits at the 1.22 region, so that could be supported. On the other hand, the 1.2660 above is significant resistance, and we just started to pile into the resistance region, so it’s not a huge surprise to see that we’ve seen a little bit of a pushback. Whether or not that continues remains to be seen, but right now it seems as if we are content to simply hang around in this area.</p>	
    	<p>Keep in mind that this coming week could be a bit volatile, in reaction to the Non-Farm Payroll announcement in the United States as most of the liquidity would have been taken out of the market on Friday, and then again in Europe on Monday. Regardless, we have a handful of levels to pay attention to, and I do think it is probably only a matter of time before we make a decision as to whether or not we are going to truly break out or pull back toward the bottom of the overall consolidation area that we have been in for the last couple of months. Keep your position size reasonable, this is going to continue to be a very volatile and choppy market, right along with the rest of the Forex world. The most important thing you can do is practice sound money management in this environment.</p>
    </div>
  },
  {
    id: 298,
  ...
  },
  {
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 7, 2023 - 6:01 PM',
    cover: 'https://ncx.cx/images/ncx-blog-121.jpg',
    content: <div className="blog-content">
      <p><strong>British Pound vs US Dollar Technical Analysis</strong></p>
      <p>The British pound initially tried to rally during the trading session on Tuesday but gave back gains to show signs of hesitation. At this point, it looks like we are trying to build up enough pressure to go lower, breaking down below the support. The market has continued to fail every time we get close to the 50-Day EMA, so it is more likely going to continue to be a situation where traders are fading the rally, taking advantage of US dollar strength.</p>
      <p>The 50-Day EMA is also backed up by the 200-Day EMA, so therefore I think there are quite a few different players that look to short this market every time it tries to rally. Ultimately, this is a situation where if we can break down below the 1.1850 level underneath, then the market is likely to drop down to the 1.15 level underneath. The 1.15 level is a large, round, psychologically significant figure, and an area where we have seen a lot of noise previously. That previous resistance should now end up being supported.</p>
      <p>On the other hand, if we turned around and took out the 200-Day EMA, then it’s likely that we could go to the 1.23 level. After that, then we have the 1.25 level above, that is where we have the double top, which started at the 1.24 level. Ultimately, this is a market that I think continues to see a lot of noisy behavior, but I also believe that this is a market that has a major overhang, and therefore it’s going to be difficult for it to go much higher.</p>
      <p>Furthermore, the Federal Reserve is going to remain tighter for longer when it comes to the monetary policy, and therefore it’s likely that we would see the US dollar continue to be strong in general. All things being equal, this is a situation where we continue to see a lot of downward pressure on each rally, and therefore I will be fading each one at the first signs of exhaustion. True, support has held fairly well so far, but it is only a matter of time before it gives way to all of this mounting pressure.</p>
    </div>
  },
  {
    id: 121,
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 7, 2023 - 5:41 PM',
    cover: 'https://ncx.cx/images/ncx-blog-123.jpg',
    content: <div className="blog-content">
      <p><strong>Euro vs US Dollar Technical Analysis</strong></p>
      <p>The Euro initially tried to rally during the trading session on Tuesday but gave back gains near the 1.07 level. The 1.07 level is a large, round, psychologically significant figure and an area where we have seen both support and resistance recently. That being said, the market also has been banging around between the 50-Day EMA and the 200-Day EMA indicators, which typically will mean that we have a lot of noise out there that is going to continue to be a problem.</p>
      <p>If we were to turn around and break down below the 200-Day EMA, which is basically at the 1.05 level, then it opens up a trap door to much lower prices, perhaps down to the 1.03 level, followed by the parity level. The parity level of course is an area that will attract a lot of attention due to the fact that it is a level that makes for a good headline number. However, I think at this point we’ve got a situation where we have so much in the way of noise and volatility out there that sooner or later the Euro starts to fall. After all, when you look at the chart you can see that we had fallen rather drastically from the 1.10 level. The last couple of weeks have been very noisy, but it’s also worth noting that it was kicked off by a massive shot lower.</p>
      <p>Jerome Powell is speaking during the session, in front of the United States Congress. That could be a mover of markets, but we will have to wait and see. Either way, it looks as if the sellers are going to continue to take hold of this market, especially as we sold off so drastically from the 50% Fibonacci level of the massive selloff that occurred last year. I think we continue to see more of the same, and therefore I think it’s only a matter of time before we go lower. That being said, if we were to turn around and break above the recent highs, that could change everything but I would not hold my breath on that.</p>
    </div>
  },
  {
    id: 122,
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 7, 2023 - 5:35 PM',
    cover: 'https://ncx.cx/images/ncx-blog-124.jpg',
    content: <div className="blog-content">
      <p><strong>Australian Dollar vs US Dollar Technical Analysis</strong></p>
      <p>The Australian dollar has fallen rather hard during the course of the trading session on Tuesday, as we are now well below the 0.67 level. At this point, the market is looking likely to go down to the 0.6650 level, which is an area where we have seen a lot of previous support. If we were to break down below there, then the market is likely to drop down to the 0.6450 level. Furthermore, we have recently seen the so-called “death cross”, when the 50-Day EMA breaks down below the 200-Day EMA indicator and is generally seen as a negative turn of events. Because of this, I think you got a situation where the market will continue to be more dollar positive than anything else.</p>
      <p>This will continue to be the case as long as the Federal Reserve has decided to be “tighter for longer”, as they have publicly stated. At this point, I think it’s only a matter of time before rallies get sold into at the first signs of exhaustion. With that being said, I like the idea of fading these rallies and taking advantage of momentum, as it continues to see a lot of noise. The Australian dollar of course is a very sensitive currency when it comes to global growth and of course the Chinese mainland, both of which are a bit shaky at the moment, despite the fact that the Chinese have less than desirable numbers at times.</p>
      <p>The size of the candlestick does suggest that there is a significant amount of downward pressure building in this market, so I do think that a breakdown is only a matter of time before it actually happens. Rallies at this point will more likely than not be sold into at the first signs of exhaustion, and it would take the market breaking above the 200-Day EMA for me to change my opinion on this pair. All things being equal, I think the US dollar continues to be one of the favorite currencies around the world, and therefore I do believe that the Aussie will continue to be threatened by the juggernaut that is the greenback.</p>
    </div>
  },
  {
    id: 123,
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 6, 2023 - 6:17 PM',
    cover: 'https://ncx.cx/images/ncx-blog-125.jpg',
    content: <div className="blog-content">
      <p><strong>British Pound vs US Dollar Technical Analysis</strong></p>
      <p>The British pound has gone back and forth during the course of the trading session on Monday, as it looks like it is still trying to figure out what to do with itself. Because of this, the market will be very noisy, but ultimately it looks as if we are going to have to make a bigger decision. Until we get some kind of impulsive candlestick, it’s a bit difficult to get overly aggressive in this pair. It seems as if the 1.20 level is going to continue to be a magnet for the price, therefore you need to pay close attention to how the market continues to react to this area. So far, it looks as if it’s ready to grind back and forth but if you look at the chart a little closer, you can recognize that there have been a series of lower highs along the way.</p>
      <p>Underneath, the 1.1925 level has offered a bit of support, and I think that probably extends down to the 1.1850 area where we had seen a little bit of support previously. Breaking down that level will then kick off the major leg lower, perhaps opening up a move down to the 1.15 level. The 1.15 level of course is very likely to continue to be important due to the fact that it is a large, round, psychologically significant figure, so with that in mind, I think it’s probably a nice target.</p>
      <p>However, if we were to turn around and break above the 1.21 level, then it’s possible that we could go to the 1.24 level above, but that double top I think would be difficult to break above anytime soon and I think it extends all the way to the 1.25 level as well. In other words, there’s a lot of noise out there that is going to continue to be a major issue, so therefore I think you’ve got a situation where you have to look at this more or less from a “fade the rally” type of plan, but you should also perhaps look at this as a short-term market more than anything else at the moment.</p>
    </div>
  },
  {
    id: 124,
  ...
  },
  {
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 6, 2023 - 5:54 PM',
    cover: 'https://ncx.cx/images/ncx-blog-128.jpg',
    content: <div className="blog-content">
      <p><strong>Australian Dollar vs US Dollar Technical Analysis</strong></p>
      <p>The Australian dollar has fallen a bit during the trading session on Monday, as we continue to look at the 0.67 level underneath as a potential support level. It has offered support over the last couple of days, so it does make a certain amount of sense that traders continue to come back into this picture. Furthermore, there is a little bit of support underneath there reaching down to the 0.66 level, and therefore I think it’s going to be difficult for this pair to simply fall through the floor. However, it’s probably worth noting that the market has been very choppy in general, therefore I think you probably continue to see a lot of back and forth trading more than anything else.</p>
      <p>The 50-Day EMA has just broken back below the 200-Day EMA, forming the so-called “death cross”, then longer-term sellers may come in and hold short positions. That being said, the 0.68 level above could be resistance, right along with those moving averages. With that being said, the market is likely to continue to see a lot of volatility, and therefore I would not hang on to a position for far too long, due to the fact that there are so many different things out there moving the market around.</p>
      <p>Keep in mind that the Aussie of course is going to be very sensitive to the idea of global growth, or perhaps even the lack of it, and therefore you need to pay close attention to inflation numbers, and of course GDP numbers around the world. The Australian economy is highly levered to the Chinese economy as well, which although just reopening from the pandemic lockdowns, does not necessarily look blazing hot either, although in all fairness the Chinese economy is probably one of the better performers at the moment.</p>
      <p>That being said, if the rest of the world is going to slow down, then the Chinese economy will of course suffer as a result. If we do break down below the support region underneath, it could open up a move down to 0.65 level, which is an area where we had seen a lot of noise previously. Breaking above the moving averages could open up a move to the 0.70 level, but that would take a significant amount of momentum.</p>
    </div>
  },
  {
    id: 127,
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'Mar 3, 2023 - 7:17 PM',
    cover: 'https://ncx.cx/images/ncx-blog-129.jpg',
    content: <div className="blog-content">
      <p><strong>British Pound vs US Dollar Weekly Technical Analysis</strong></p>
      <p>The British pound has initially rallied during the course of the trading week to break above the 1.20 level, reaching towards 1.21 level before pulling back. We ended up forming a bit of an inverted hammer, so therefore it’s going to be interesting to see how this plays out. The previous week formed the same candlestick, and the week before that was very similar. In other words, every time we rally it looks like the sellers are starting to come back in and push lower.</p>
      <p>It looks as if the area around the 1.19 level is going to continue to be support, so I do think it’s worth watching. Breaking down through that area then opens up a bigger drop from what I can see, which of course is what would coincide with the longer-term trend. We had bounced rather significantly to test the 50% Fibonacci level, and then even formed a bit of a double top in that area. By doing so, this is a market that I believe continues to be very noisy, but in the end will find plenty of sellers to come in and punish it.</p>
      <p>If global risk appetite continues to struggle, I just don’t see how this market takes off to the upside. A breakdown below the 1.1850 level will open up a move down to the 1.15 level, followed by the 1.1250 level. That does not necessarily mean that it will be sudden or have a lot of momentum, but that certainly looks as if it would be the more likely of scenarios right now.</p>
    </div>
  },
  {
    id: 46,
  ...
  },
  {
    ...
    content: <div className="blog-content">
      ...
      <p>“The incremental nature of the gas demand suggests an early resurgence of network activity may be underway,” wrote Glassnode in its weekly newsletter on Monday.</p>
      ...
      <p>You Can Thank NFTs for Falling Ethereum Gas Prices</p>
      <p>Specifically, gas used by Ethereum NFT transactions has risen by 97% for two months straight, approaching levels last seen during the “NFT boom” from mid-2021 to mid-2022. Much of that rising activity is thanks to Blur, an NFT marketplace launched in October that’s now overtaken OpenSea in terms of trading volume.</p>
      ...
      <p>Other drivers of NFT activity include all-new projects launched by the industry’s biggest names, including Yuga Labs’ Dookey Dash game and the announcement of Doodles 2 last month.</p>
      ...
      <p>Not all corners of the Ethereum ecosystem are seeing rising revenues. In an interview with Decrypt on Friday, Doodle CEO Julian Holguin said that the competition between OpenSea and Blur is constricting cash available to many NFT projects that relied on secondary royalties for revenue.</p>
    </div>
  },
  {
    id: 50,
  ...
  },
  {
    ...
    content: <div className="blog-content">
      <h3>Australian Dollar vs US Dollar Technical Analysis</h3>
      <p>The Australian dollar has pulled back a bit during the trading session on Tuesday as we continue to see a lot all volatility in this pair. We are hanging around the 200-Day EMA, an indicator that a lot of people pay attention to. Because of this, I think it makes quite a bit of sense that we would see choppy behavior. The 0.69 level being in the same general vicinity probably as to the volatility as well, so it is worth pointing that out also.</p>
