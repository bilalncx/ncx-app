const data = [
  ...
  },
  {
    ...
    authorAvatar: 'https://ncx.cx/images/avatar-placeholder.svg',
    authorContent: '',
    createdAt: 'July 24, 2023 - 5:05 AM', 
    cover: 'https://res.cloudinary.com/dqbcnwbvy/image/upload/v1690213115/ncx-blog-944_rgvqaf.webp',
    content: <div className="blog-content">
    	<h3>In this article:</h3>
    	<p>By Noah Browning</p>
    	<p>LONDON (Reuters) -Oil prices rose on Monday as tightening supply and hopes for Chinese stimulus measures underpinned Brent at well above $80 a barrel, even as traders expected more rate hikes from U.S. and European central banks.</p>	
    	<p>Brent crude futures were up 91 cents, or 1.1%, at $81.98 a barrel by 1415 GMT. U.S. West Texas Intermediate (WTI) crude was at $78.12 a barrel, also up $1.05, or 1.3%.</p>	
    	<p>The benchmarks rose 1.5% and 2.2% respectively last week, their fourth straight of week of gains, as supply is expected to tighten following OPEC+ cuts.</p>
      <p>Fighting also escalated last week in Ukraine after Russia withdrew from a U.N.-brokered safe sea corridor agreement for grain exports.</p>
      <p>Oil's rise has reflected "tightening conditions as Saudi oil output cuts impact the market ... even as summer demand has been somewhat stronger for gasoline and jet fuel", Citi Research said in a note.</p>
      <p>The bank said it sees some upside for oil over the summer and forecast an average price in the third quarter of $83 a barrel.</p>
      <p>"While another Fed rate hike this week may drive some short-term price volatility, we expect tightening market conditions on OPEC's supply cuts and increasing market speculation of further stimulus in China to continue to push prices higher through 3Q23," analysts from National Australian Bank said in a note.</p>
      <p>Investors have priced in quarter-point hikes from the Federal Reserve and European Central Bank this week, so the focus will be on what Fed Chair Jerome Powell and ECB President Christine Lagarde say about future rate increases. [MKTS/GLOB]</p>
      <p>Rising interest rates have dampened investment and strengthened the greenback, making dollar-denominated commodities more expensive for holders of other currencies.</p>
      <p>In China, the state planner on Monday unveiled measures to spur private investment in some infrastructure sectors, and said it will also strengthen financing support for private projects.</p>
      <p>Market participants expect Beijing to implement targeted stimulus measures to support its flagging economy, likely boosting oil demand in the world's No. 2 consumer.</p>
      <p>(Additional reporting by Florence Tan and Emily Chow; Editing by Jan Harvey and David Holmes)</p>
    </div>
  },
  {
    id: 585,
    title: 'Newmont Corporation (NYSE:NEM) Q2 2023 Earnings Call Transcript',
    category: 'Commodities',
    subCategory: ['Newmont', 'Corporation', 'NYSE:NEM'],
    description: <div className="blog-desc">
